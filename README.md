...
- 2019.3 - 现在: 北京网易有道-语音实习生 (0基础学习中)
- 2018.3 - 现在: SIGSDS实验室 (任务型对话系统)
- 2018.11 - 2019.3: CVTE中央研究院-nlp实习生 (问答型对话系统)
...
项目经历
- 2019.2-2019.3: 使用 srcapy-redis 爬取百度知道相似问答对。
- 2018.12-2019.2: 目前在CVTE中央研究院 计划在月底前优化完线上问答机器人(微信公众号:希沃学院)的性能(主要是:用户反馈的解决率).主要是在做检索式的问答匹配.目前已将模型的top3从0.46提升到 0.76.
